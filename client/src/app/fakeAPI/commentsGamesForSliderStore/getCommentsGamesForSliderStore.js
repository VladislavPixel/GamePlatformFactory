...
export function getCommentsForTheLastWeek(idGame) {
	return new Promise((resolve, reject) => {
		...
		const updateSliceReqult = sliceResult.map(comment => {
