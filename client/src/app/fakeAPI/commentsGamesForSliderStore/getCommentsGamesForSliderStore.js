...
const commentsGames = [
	{_id: "docvbta324234879kjljkmmmmmm", funnyStatus: [], awards: [], consonants: [], disagree: [], sucks: [], likes: [], dislikes: [], hisDiscussions: ["dis1", "dis2", "dis3", "dis4", "dis5", "dis6", "dis7", "dis8", "dis9", "dis10", "dis11", "dis"], idGame: "2dota2lol56", userId: "fdvvbvbvvbvbv8088", date: 1656968400000, status: "negative", text: "Сложный макроконтроллинг перса, но мне нравится дроч."},
	...
	{_id: "123tytytyt45677777777435345cvbcvb", funnyStatus: [], awards: [], consonants: [], disagree: [], sucks: [], likes: [], dislikes: [], hisDiscussions: [], idGame: "2dota2lol56", userId: "cloneityuo2134", date: 1658264400000, status: "positive", text: "Игра очень затягивает, мы приходим после универа с пацанами и катаем игры. Красота)"},
