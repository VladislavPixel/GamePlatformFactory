...
const commentsGames = [
	{_id: "docvbta324234879kjljkmmmmmm", funnyStatus: [], awards: [], consonants: [], disagree: [], sucks: [], likes: [], dislikes: [], hisDiscussions: ["dis1", "dis2"], idGame: "2dota2lol56", userId: "fdvvbvbvvbvbv8088", date: 1656968400000, status: "negative", text: "Сложный макроконтроллинг перса, но мне нравится дроч."},
