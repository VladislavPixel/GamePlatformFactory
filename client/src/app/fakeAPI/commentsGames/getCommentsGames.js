const commentsGames = {
	...
	"3atomicHeart564": [],
	"17warface54646mbn": [
		{userId: "vcbcv657989", date: "01.02.2022", text: "да я посоветую потому что игра не плохая но донат тут очень сильно влияет .Но спасибо стиму что он создает паки с донатными пушками поэтому я и советую."},
	...
	"2dota2lol56": [],
	"1eldenRingMiddle77": [
		{userId: "9009768345gfhfgh", date: "27.03.2022", text: "Очень люблю все серию Souls и эта игра не является исключением. В игре есть сломанные механики, оружие и противники, но это ничуть не мешает прохождению. Всё как всегда, только новее. Рекомендую."},
