...
const GameCardCommentsSlider = ({ imageMiddle, altImageMiddle, price, title, textPrice }) => {
	return (
		<div className="comments-slider-block__wrap-poster wrap-poster-comments-slider">
			...
			<div className="wrap-poster-comments-slider__footer">
				<span className="wrap-poster-comments-slider__price">{textPrice ? textPrice : getValuePrice(price)}</span>
